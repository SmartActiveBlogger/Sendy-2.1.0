	    ...
	    <h2><?php echo _('Define recipients');?></h2><br/>
		    ...
		    <?php else:?>
			    ...
			    ?>
							    ...
							    <div class="alert" id="amazon-sns-access">
								  <p><?php echo _('Sendy is unable to verify and setup bounces & complaints handling for your \'From email\' address. Please attach \'AmazonSNSFullAccess\' policy in addition to \'AmazonSESFullAccess\' policy to your IAM credentials in your <a href="https://console.aws.amazon.com/iam/home#users" target="_blank">IAM console</a> (see Step 5.7 of the <a href="https://sendy.co/get-started" target="_blank">Get Started Guide</a>) then refresh this page. ');?> </p>
								  <p><?php echo _('Once this is done, Sendy will be able to setup bounces & complaints handling automatically (including Amazon SNS topics, subscriptions and notifications).');?></p>
								</div>
			    
			    <?php 		
				    		else:
				    		
					    		echo '<p class="error">'._('Error').': '.$e->getMessage().'</p>';
